...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm border-2 border-border bg-card p-1 transition-all hover:shadow-brutal-sm active:translate-x-0.5 active:translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-ring">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-display text-xl font-extrabold leading-none tracking-tight', className)}
    {...props}
  />
));
