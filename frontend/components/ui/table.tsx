...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('border-t-2 border-border bg-muted/50 font-bold [&>tr]:last:border-b-0', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-bold uppercase tracking-wide text-muted-foreground text-xs [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
